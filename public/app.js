...
const I18N = {
  zh: {
    ...
    attachmentTitle: "上传附件（可选）",
    attachmentDesc: "可选上传现场平面图、摄像头清单或其他资料。",
    ...
    noRecommendEmpty: "填写组名或位置后，会出现推荐项；推荐项不会自动勾选。",
    hit: "命中",
    multiSelect: "可多选",
  ...
  ja: {
    ...
    attachmentTitle: "添付資料（任意）",
    attachmentDesc: "必要に応じて、平面図、カメラ一覧、その他資料をアップロードできます。",
